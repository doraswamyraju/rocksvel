        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-1000 transform ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-lg md:text-xl text-brand-100 mb-10 max-w-lg leading-relaxed font-light">
              Empower your team with world-class leadership development, sales mastery, and growth strategies tailored for the modern market.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-brand-100 text-sm font-medium">
               <div className="flex items-center gap-3">
                  <div className="bg-gradient-to-br from-blue-500 to-cyan-500 p-1.5 rounded-full shadow-lg shadow-blue-500/30">
               ...
               <div className="flex items-center gap-3">
                  ...
                  <span>Certified Industry Experts</span>
               </div>
               <div className="flex items-center gap-3">
                  <div className="bg-gradient-to-br from-blue-500 to-cyan-500 p-1.5 rounded-full shadow-lg shadow-blue-500/30">
                     <CheckCircle2 size={14} className="text-white" />
                  </div>
                  <span>Result-Oriented Workshops</span>
               </div>
            </div>
          </div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10 group">
               ...
               <div className="absolute bottom-8 left-8 bg-white/95 backdrop-blur-md p-4 rounded-xl shadow-xl max-w-xs border-l-4 border-brand-500 animate-pulse-slow">
                  <div className="flex items-center gap-3 mb-2">
                     ...
                     <span className="font-bold text-gray-800">Proven Results</span>
                  </div>
                  <p className="text-xs text-gray-600 font-medium">"Rocksvel helped us increase team productivity by 40% in just 2 months."</p>
               </div>
            </div>
            
            {/* Decorative dots */}
            <div className="absolute -bottom-12 -right-12 w-32 h-32 opacity-20" style={{ backgroundImage: 'radial-gradient(#ffffff 2px, transparent 2px)', backgroundSize: '12px 12px' }}></div>
          </div>
