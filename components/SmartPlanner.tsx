...
export const SmartPlanner: React.FC<SmartPlannerProps> = ({ onPlanInquiry }) => {
  ...
  const handleRequestQuote = () => {
    ...
    const message = `Hello, I have customized a training curriculum using your Smart tool and would like a quote.
...
Please contact me to finalize this plan.`;
    ...
    const inquiryData = {
      name: "Smart Planner User", // In a real app, you'd ask for this
      email: "pending@input.com",  // or redirect to contact form with state
    ...
    if (onPlanInquiry) {
      ...
      // If no handler, maybe redirect to contact with data?
      // For now, let's just scroll to contact and pre-fill message
      // Note: Ideally we pass the structured data to the Contact form
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Reveal className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-100 to-blue-100 rounded-full px-4 py-1.5 border border-purple-200 mb-6 shadow-sm">
            ...
            <span className="text-purple-900 text-sm font-bold tracking-wide">Smart-Powered Training Architect</span>
          </div>
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Generate a baseline with Smart, then customize it to fit your exact needs. Select modules, edit details, and get a quote.
          </p>
        </Reveal>
            ...
            {step === 2 && (
              <div className="h-full overflow-y-auto custom-scrollbar animate-fadeIn flex flex-col p-8">
                <div className="bg-blue-50 text-blue-900 p-4 rounded-lg mb-6 text-sm leading-relaxed border border-blue-100 flex gap-3 shadow-sm">
                  ...
                  <div>
                    <strong>Smart Suggestion:</strong> {intro}
                  </div>
                </div>
