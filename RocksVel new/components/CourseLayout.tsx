          ...
          <Reveal className="bg-gray-900 rounded-[3.5rem] overflow-hidden shadow-4xl flex flex-col lg:flex-row">
            ...
            <div className="lg:w-3/5 p-12 lg:p-20 bg-white">
              <div className="max-w-md mx-auto">
                ...
                <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); alert('Inquiry Sent! RocksVel team will contact you.'); }}>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">Full Name</label>
                        <input type="text" className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-brand-500 focus:outline-none font-bold placeholder-gray-300" placeholder="e.g. John Doe" required />
                    </div>
                    <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">Phone Number</label>
                        <input type="tel" className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-brand-500 focus:outline-none font-bold placeholder-gray-300" placeholder="+91..." required />
                    </div>
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">Work/Personal Email</label>
                    <input type="email" className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-brand-500 focus:outline-none font-bold placeholder-gray-300" placeholder="email@example.com" required />
                  </div>
